    ...
    <div className="content">
      ...
      >
        ...
        <p className="text-xl leading-relaxed">
          <br />
          <strong>
            The Student Security League (SSL) is LSU&apos;s premier student organization dedicated to hands-on cybersecurity education and exploration.
          </strong>
        ...
        <p className="text-xl leading-relaxed mt-6">
          <br />
          Our mission is to empower the next generation of cybersecurity professionals by emphasizing learning through doing—because the best way to understand security is to break,
